...
# Add to crontab: * * * * * /bin/bash /home/pornwoo1/tunerip/api/keep_alive.sh
...
if ! pgrep -f "uvicorn main:app" > /dev/null; then
    ...
    nohup /home/pornwoo1/tunerip/api/venv/bin/python3 -m uvicorn main:app --host 0.0.0.0 --port 8001 --workers 4 >> /home/pornwoo1/tunerip/api/api.log 2>&1 &
fi
...
if ! pgrep -f "nokey@localhost.run" > /dev/null; then
    ...
    nohup ssh -o StrictHostKeyChecking=no -o ExitOnForwardFailure=yes -o ServerAliveInterval=60 -R 80:localhost:8001 nokey@localhost.run >> /home/pornwoo1/tunnel.log 2>&1 &
fi
