#!/usr/bin/env python3
"""
Complete Hindi playlist page translation - ALL content
"""

from pathlib import Path

# Complete Hindi translations - every single English string
hindi_translations = {
    # Table headers and content
    'Format': 'फॉर्मेट',
    'Best For': 'सर्वोत्तम उपयोग',
    'Quality Options': 'गुणवत्ता विकल्प',
    ...
    # Section headings
    'Batch Conversion Masterclass': 'बैच रूपांतरण मास्टरक्लास',
    'Preserve Original Order and Titles': 'मूल क्रम और शीर्षक संरक्षित करें',
    'Flexible Format Selection for Playlists': 'प्लेलिस्ट के लिए लचीला फॉर्मेट चयन',
    'High-Concurrency Processing': 'उच्च-समवर्ती प्रसंस्करण',
    'Support for Massive Playlists': 'विशाल प्लेलिस्ट के लिए समर्थन',
    'Download Auto-Generated Mixes': 'ऑटो-जनरेटेड मिक्स डाउनलोड करें',
    'Ideal for Educators and Students': 'शिक्षकों और छात्रों के लिए आदर्श',
    'Handling Unavailable or Private Videos': 'अनुपलब्ध या निजी वीडियो को संभालना',
    'How to Download a Full Playlist': 'पूर्ण प्लेलिस्ट कैसे डाउनलोड करें',
    ...
    # FAQ questions
    'Is there a maximum playlist length?': 'क्या प्लेलिस्ट की अधिकतम लंबाई है?',
    'Are playlists downloaded in order?': 'क्या प्लेलिस्ट क्रम में डाउनलोड होती हैं?',
    'Is there a limit to the number of videos in a playlist?': 'क्या प्लेलिस्ट में वीडियो की संख्या की सीमा है?',
    'Will it download as one giant file or separate files?': 'क्या यह एक विशाल फ़ाइल या अलग फ़ाइलों के रूप में डाउनलोड होगा?',
    "Can I download a 'Watch Later' playlist?": "क्या मैं 'Watch Later' प्लेलिस्ट डाउनलोड कर सकता हूं?",
    'What happens if the playlist contains a live stream?': 'यदि प्लेलिस्ट में लाइव स्ट्रीम है तो क्या होगा?',
    'How long does a 50-video playlist take to convert?': '50-वीडियो प्लेलिस्ट को परिवर्तित करने में कितना समय लगता है?',
    'Do I have to click download 50 times?': 'क्या मुझे 50 बार डाउनलोड पर क्लिक करना होगा?',
    'Does it download the playlist thumbnail?': 'क्या यह प्लेलिस्ट थंबनेल डाउनलोड करता है?',
    "Can I download a channel's entire video list?": 'क्या मैं किसी चैनल की संपूर्ण वीडियो सूची डाउनलोड कर सकता हूं?',
    'Are the files numbered?': 'क्या फ़ाइलें क्रमांकित हैं?',
    'Why did only half the videos appear?': 'केवल आधे वीडियो ही क्यों दिखाई दिए?',
...
# Translate
translate_file('web/hi/youtube-playlist-downloader/index.html')
print("\n✅ Hindi playlist page 100% complete!")
